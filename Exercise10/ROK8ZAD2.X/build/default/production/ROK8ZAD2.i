...
void ServoRotiraj180() {
    ...
    for(i=0;i<50;i++) {
        RC0=1;
        _delay((unsigned long)((2200)*(20000000/4000000.0)));
        RC0=0;
        _delay((unsigned long)((17800)*(20000000/4000000.0)));
    }
}
...
void main(void) {
    ...
    do {
        ...
        printf("\r1. Rotacija servomotora 3 puta u obe strane");
        printf("\r2. Brojanje na 7seg displeju");
        printf("\r3. Ispis temperature na LCD displeju");

        printf("\r******");
        printf("\rMolimo vas odaberite opciju 1, 2 ili 3: ");
        ...
        switch(opcija) {
            case '1':
                ...
                break;
            case '2':
                printf("\r\rIzabrali ste opciju 2. \r");
                Lcd_Clear();
                Lcd_Set_Cursor(1,1);
