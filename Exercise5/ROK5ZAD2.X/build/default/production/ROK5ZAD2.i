...
void ServoRotiraj0() {
    ...
    for(i=0;i<50;i++) {
        ...
        RB0=0;
        _delay((unsigned long)((19200)*(16000000/4000000.0)));
    }
}
...
void ServoRotiraj90() {
    ...
    for(i=0;i<50;i++) {
        ...
        RB0=0;
        _delay((unsigned long)((18500)*(16000000/4000000.0)));
    }
}
...
void ServoRotiraj180() {
    ...
    for(i=0;i<50;i++) {
        RB0=1;
        _delay((unsigned long)((2200)*(16000000/4000000.0)));
        RB0=0;
        _delay((unsigned long)((17800)*(16000000/4000000.0)));
    }
}
